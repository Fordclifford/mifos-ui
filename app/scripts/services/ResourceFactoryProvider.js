(function (module) {
    mifosX.services = _.extend(module, {
        ResourceFactoryProvider: function () {
            var baseUrl = "" , apiVer = "/fineract-provider/api/v1", apiVerData = "/fineract-provider/api/v1", tenantIdentifier = "";
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    DataTablesResource: defineResource(apiVerData + "/datatables/:datatablename/:entityId/:resourceId", {datatablename: '@datatablename', entityId: '@entityId', resourceId: '@resourceId'}, {
                        getAllDataTables: {method: 'GET', params: {}, isArray: true},
                        getTableDetails: {method: 'GET', params: {}},
                         getMoreClientDetails: {method: 'GET', params: {}},
                        update: {method: 'PUT'}
                    }),
                    ...
                    journalEntriesResource: defineResource(apiVer + "/journalentries/:trxid", {trxid: '@transactionId'}, {
                     ...
                     budgetResource: defineResource(apiVer + "/budget/:budgetAccountId", {budgetAccountId: '@budgetAccountId'}, {
                        get: {method: 'GET', params: {accountId: '@budgetAccountId'}},
                        search: {method: 'GET', params: {}},
                        getAllBudget: {method: 'GET', params: {},isArray: true},
                        update: { method: 'PUT' }
                    }),
