    ...
    var defineRoutes = function ($routeProvider, $locationProvider) {
        $routeProvider
            ...
            .when('/editglaccount/:id', {
             ...
             .when('/budget', {
                templateUrl: 'views/accounting/budget.html'
            })
             .when('/createbudget', {
                templateUrl: 'views/accounting/createbudget.html'
            })
            .when('/viewbudget/:id', {
                templateUrl: 'views/accounting/viewbudget.html'
            })
            .when('/editbudget/:id', {
                templateUrl: 'views/accounting/editbudget.html'
            })                        
            .when('/freqposting', {
